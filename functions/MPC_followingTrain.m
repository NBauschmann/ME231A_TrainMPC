function [feas, xOpt, uOpt, predErr, x_pred_l, x_pred_f, u_pred_l, u_pred_f] = MPC_followingTrain(x0_l, x0_f,param,MODEL,...
        slope_,radius_,DPspeed_,maxspeed_,p_sampled, x_pred_l, u_pred_l, feas)
    
%% performs MPC for following Train from precomp x_pred_l, u_pred_l
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Inputs 
...
% x_pred_l      all the finite time horizon predictions of the leading
%               train
% u_pred_l      all the finite time horizon optimal input sequences of 
%               the leading train
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Outputs
...
uOpt_f_t = 0.5 * 1.8449e+05*ones(1,param.Np) ;

% indicator of MPC iteration
i = 1 ;

for i = 1:length(feas{1})
    tic
    % apriori estimation
