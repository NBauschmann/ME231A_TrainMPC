function [feas, xOpt, uOpt, predErr, x_pred_l, x_pred_f, u_pred_l, u_pred_f] = MPC_leadingTrainSC(x0_l, x0_f,param,MODEL,...
...
%         slope_, radius_, limspeed_, maxspeed_);
    ...
    [feas_l_t, xOpt_l_t, uOpt_l_t, JOpt_l_t] = cftoc_leadingTrainSC(x0_l, ... 
